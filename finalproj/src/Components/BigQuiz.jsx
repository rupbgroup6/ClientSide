    ...
    render() {
        ...
        return (
            <div>
              ...
              <br></br>
              {this.state.allFull ? <Row><Col style={{ textAlign: "center" }}><Link to={'/game/'+ this.props.refreshProfile() }> <Button variant="outline-primary">Let's Continue</Button></Link></Col></Row> : ""}
            </Row>{/*end of card2 */}
            </div>
        )
    }
