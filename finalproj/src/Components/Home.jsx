                        ...
                        <Row className="menu" style={{ marginTop: "20px" }} >
                            <Col className="menu">
                                <Row className="menu" class="btn-group" role="group" aria-label="Basic example" >
                                    ...
                                    <Col xs={5}><Link to={"/UserBarChart/" + this.state.id }><button type="button" style={{ float: "left" }}><img style={{width:"80%"}} src={apostrophes} alt="" ></img><h6>ציטטות מנהלים</h6></button></Link> </Col>
                                    <Col xs={1}></Col>
                                </Row >
                            </Col>
                        </Row>
