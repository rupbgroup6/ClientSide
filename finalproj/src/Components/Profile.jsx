        ...
        fetch(url, {
            ...
            .then(
              (result) => {
                ...
                $('#daredevil').css({'height': daredevilAvg,'background':'linear-gradient(to left, rgba(255,0,0,0), rgba(300,300,0,1))'})
                $('#believer').css({'height': believerAvg,'background':'linear-gradient(to left, rgba(255,0,0,0), rgba(300,0,50,1))'})
                $('#revol').css({'height': revolAvg,'background':'linear-gradient(to left, rgba(255,0,0,0), rgba(300,100,0,1))'})
                $('#champ').css({'height': champAvg,'background':'linear-gradient(to left, rgba(255,0,0,0), rgba(0,100,100,1))'})
                $('#calc').css({'height': calcAvg,'background':'linear-gradient(to left, rgba(255,0,0,0), rgba(0,300,50,1))'})
                ...
                <div className="card4" style={{ marginTop: "3%", marginBottom: "3%" }}>
                    ...
                    <Row>  
                        ...
                        <Row style={{marginTop:"20px" }}>
                            <Col xs={3}><h6>רמה נמוכה</h6></Col>
                            <Col xs={3} ><button onClick={this.Survivor}><div id="survivor"><p >השורד</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Analyst}><div id="analyst"><p>המנתח</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Fit}><div id="fit"><p>המתאים</p></div></button></Col>
                        </Row>

                        
                        <Row style={{marginTop:"20px"}}>
                            <Col xs={3}><h6>רמה בינונית</h6></Col>
                            <Col xs={3}><button onClick={this.Believer}><div id="believer"><p>המאמין</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Balanced}><div id="balanced"><p>המאזן</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Daredevil}><div id="daredevil"><p>המעז</p></div></button></Col>
                        </Row>

                        <Row style={{marginTop:"20px", marginBottom:"25px"}}>
                            <Col xs={3}><h6>רמה גבוהה</h6></Col>
                            <Col xs={3}><button onClick={this.Revol}><div id="revol"><p>המהפכן</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Calc}><div id="calc"><p>המחושב</p></div></button></Col>
                            <Col xs={3}><button onClick={this.Champ}><div id="champ"><p>האלוף</p></div></button></Col>
                        </Row>
                        </Col>          
                </Row>
